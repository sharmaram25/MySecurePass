        ...
        <div>
            <nav className="md:fixed w-full z-50 py-4 mb-5 md:md-0">
                <div className="container-fluid px-4 mx-auto flex justify-between items-center">
                    <p className="font-bold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-600">MySecurePass</p>
                    <ul className="flex space-x-4">
                        <label className="flex items-center relative w-max cursor-pointer select-none gap-1">
                            ...
                            <div className="relative w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-purple-300 dark:peer-focus:ring-purple-800 dark:bg-gray-800 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-gradient-to-r peer-checked:from-indigo-500 peer-checked:to-purple-600"></div>
                            <span className="font-medium">
